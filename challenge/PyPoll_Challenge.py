...
file_to_save = os.path.join("D:/Bootcamp/git clones/election-analysis/challenge/election_results.txt")
...
candidate_options = []
candidate_votes = {}
# Keep track of the candidate column in the data set.
candidate_column = 2

# 1: Create a county list and county votes dictionary.
county_names = []
county_votes = {}
# Keep track of the county column in the data set.
county_column = 1
